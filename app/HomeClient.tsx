...
export default function HomeClient() {
  ...
  return (
    ...
    >
      {/*
        Visually hidden — the hero below is a pure image carousel with no text
        headline. This gives the page a single, unique, keyword-relevant <h1>
        for SEO and screen readers without altering the visual design.
      */}
      <h1 className="sr-only">
        Police Dog Centre India — K9 Security Services, Detection Dogs &amp; Handler Training
      </h1>
          ...
          {SLIDES.map((src, i) => {
            ...
            return (
              ...
              >
                <img
                  src={src}
                  alt={`Police Dog Centre India K9 security operations — photo ${((i - 1 + ORIGINALS.length) % ORIGINALS.length) + 1}`}
